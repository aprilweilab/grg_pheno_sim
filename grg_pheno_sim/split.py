...
def split_effect_sizes(effect_sizes_df, return_print=False, return_list=False):
  ...
  df_dict = {k: v.sort_values('mutation_id') for k, v in effect_sizes_df.groupby('causal_mutation_id')}
...
def split_genetic_values(genetic_values_df, return_print=False, return_list=False):
  ...
  df_dict = {k: v.sort_values('sample_node_id') for k, v in genetic_values_df.groupby('causal_mutation_id')}
