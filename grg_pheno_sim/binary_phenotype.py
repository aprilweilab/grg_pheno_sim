...
def sim_binary_phenotypes(grg, model, num_causal, population_prevalence, random_seed, normalize_genetic_values_before_noise=False, noise_heritability=None, user_mean=None, user_cov=None, normalize_genetic_values_after=False, save_effect_output=False, effect_path=None, standardized_output=False, path=None, header=False):
  """
...
def sim_binary_phenotypes_custom(grg, input_effects, population_prevalence, normalize_genetic_values_before_noise=False, noise_heritability=None, user_mean=None, user_cov=None, normalize_genetic_values_after=False, save_effect_output=False, effect_path=None, standardized_output=False, path=None, header=False):
  """
  Function to simulate phenotypes in one go by combining all intermittent stages.
